...
let moves =
 [(Circle 1, [Square (EastOf, Circle 1); Square (WestOf, Circle 1)]);
  ...
  (Square (SouthOf, Circle 13), [Circle 14; Square (EastOf, Circle 30); Circle 32]);
  ...
  (Square (NorthOf, Circle 124), []);
  (Square (WestOf, Circle 124), []);
  ...
  (Square (NorthOf, Circle 151), []);
  (Square (EastOf, Circle 151), [Circle 153]);
  (Square (WestOf, Circle 151), []);
  ...
  (Square (NorthOf, Circle 161), []);
  (Square (EastOf, Circle 161), []);
  (Square (SouthOf, Circle 161), []);
...
let alleyways =
 [(Circle 1, [Circle 7; Circle 26]);
  ...
  (Circle 190, []);
  (Square (EastOf, Circle 190), []);
  (Square (WestOf, Circle 190), []);
  (Circle 191, []);
  (Circle 192, []);
  (Circle 193, [Circle 194]);
  (Square (EastOf, Circle 193), []);
  (Square (SouthOf, Circle 193), []);
  (Circle 194, []);
  (Square (EastOf, Circle 194), []);
  (Circle 195, [])]
